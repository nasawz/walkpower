...
(lib.tile_mc = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#00FFFF").s().p("AjTDUIAAmnIGnAAIAAGng");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.tile_mc, new cjs.Rectangle(-21.2,-21.2,42.5,42.5), null);


(lib.mingdan_txt_mc = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
(lib.dice_label = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-7,-25,1.2,1.2);

	this.instance_1 = new lib._1();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-3,-23,1.2,1.2);

	this.instance_2 = new lib._2();
	this.instance_2.parent = this;
	this.instance_2.setTransform(-6,-23,1.2,1.2);

	this.instance_3 = new lib._3();
	this.instance_3.parent = this;
	this.instance_3.setTransform(-6,-23,1.2,1.2);

	this.instance_4 = new lib._4();
	this.instance_4.parent = this;
	this.instance_4.setTransform(-8,-23,1.2,1.2);

	this.instance_5 = new lib._5();
	this.instance_5.parent = this;
	this.instance_5.setTransform(-6,-23,1.2,1.2);

	this.instance_6 = new lib._6();
	this.instance_6.parent = this;
	this.instance_6.setTransform(-6,-24,1.2,1.2);

	this.instance_7 = new lib._7();
	this.instance_7.parent = this;
	this.instance_7.setTransform(-6,-22,1.2,1.2);

	this.instance_8 = new lib._8();
	this.instance_8.parent = this;
	this.instance_8.setTransform(-6,-24,1.2,1.2);

	this.instance_9 = new lib._9();
	this.instance_9.parent = this;
	this.instance_9.setTransform(-6,-24,1.2,1.2);
	...
	// Layer_1
	this.instance_10 = new lib.shengyu();
	this.instance_10.parent = this;
	this.instance_10.setTransform(-54,-17,1.329,1.329);

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(11));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-54,-17,105,26.6);


(lib.btn_wards = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// 图层_1
	this.instance = new lib._13();
	this.instance.parent = this;
	this.instance.setTransform(-77,-23.5);

	this.instance_1 = new lib.我的奖品down();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-78,-24,1.4,1.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance},{t:this.instance_1}]},2).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-77,-23.5,154,47);
...
(lib.btn_intro = function(mode,startPosition,loop) {
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(-77,-24,1.4,1.4);
...
(lib.mingdan_mc = function(mode,startPosition,loop) {
	...
	mask._off = true;
	mask.graphics.p("A9wC5IAAlxMA7hAAAIAAFxg");

	// mingdan_txt
	this.instance = new lib.mingdan_txt_mc();
	this.instance.parent = this;
	this.instance.setTransform(537.5,-1);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(-190.5,-18.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(140));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-190.5,-18.5,381,37);
...
(lib.girl = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-1,0,1,1,0,0,0,-0.5,160);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:0,regY:0,x:-0.5,y:-158},11).to({y:-160},12).wait(1));
...
(lib.dice_mc = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-134.5,-19,1.039,1.009,0,-7.7,0);
	...
	this.ss.name = "ss";
	this.ss.parent = this;
	this.ss.setTransform(-49.7,-78.4,1.141,1.141,0,0,0,-0.1,-0.1);
	...
	this.dice_label.setTransform(-48.5,-160);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(-164,-172,1.264,1.264);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

}).prototype = getMCSymbolPrototype(lib.dice_mc, new cjs.Rectangle(-174,-177,230,237.9), null);
...
(lib.walkpower = function(mode,startPosition,loop) {
	...
	// power_luxian
	this.instance_3 = new lib.luxian_mc();
	this.instance_3.parent = this;
	this.instance_3.setTransform(392,754,1,1,0,0,0,392,754);
...
an.compositions['9D9F8B35CAEC4C57A50CE9E71747BFB2'] = {

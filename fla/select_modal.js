...
lib.ssMetadata = [
		{name:"select_modal_atlas_", frames: [[944,220,76,48],[408,623,90,111],[942,449,82,71],[0,623,161,202],[500,623,151,37],[500,662,151,37],[944,270,77,45],[313,623,93,114],[163,623,148,111],[942,522,82,53],[793,0,165,218],[0,0,791,621],[793,220,149,227],[793,449,147,226]]}
];
...
(lib.select_modal = function(mode,startPosition,loop) {
	...
	this.peo_mc.setTransform(603.2,444.4);
...
// library properties:
lib.properties = {
	id: 'BB2E763C01F640CB8E12385CE18CCC8D',
	width: 1200,
	height: 760,
	fps: 24,
	color: "#FFFFFF",
...
an.compositions['BB2E763C01F640CB8E12385CE18CCC8D'] = {

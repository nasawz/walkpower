...
/***/ function(module, exports, __webpack_require__) {
	...
	function shareTo(site, data) {
	  ...
	  if (!device.isWeixin && supportNativeShare) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  qq: {
	    ...
	    api: 'http://connect.qq.com/widget/shareqq/index.html?url={{url}}&title={{title}}&desc={{digest}}&summary={{digest}}&pics={{pic}}&site={{from}}',
	    scheme: 'mqqapi://share/to_fri?src_type=web&version=1&file_type=news'
	  },
	  qzone: {
	    name: 'QQ空间',
	    icon: __webpack_require__(10),
	    api: 'http://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey?url={{url}}&title={{title}}&showcount=1&desc={{digest}}&summary={{digest}}&pics={{pic}}&site={{from}}',
	    scheme: device.isIOS ?
